...
def create_order(order_db_id: int, amount_usdt: float, description: str, goods_name: str):
    """
    Binance Pay order create karta hai. Returns dict with checkoutUrl / qrcodeLink / prepayId.
    """
...
def verify_webhook(headers: dict, raw_body: bytes) -> bool:
    ...
    Binance headers mein 'BinancePay-Timestamp', 'BinancePay-Nonce', 'BinancePay-Signature' bhejta hai.
    """
